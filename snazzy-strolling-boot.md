...
**Goal**
Build **STAR-TH** — a modernized web app version for Thai agricultural researchers (university/graduate level), focusing on rice (ข้าว) with Thai language UI and reports, plus modern features: AI result interpretation in Thai, interactive charts, and Excel/PDF export.
...
├── assets/fonts/IBMPlexSansThai-Regular.ttf   # Thai font for PDF
...
### Phase 2 — Full Features (Weeks 9–14): All STAR features
...
7. **PDF + Excel Export (Week 13–14)** → `export/pdf_report.py`, `export/excel_export.py`
...
### Phase 3 — AI Features (Weeks 15–22): Claude integration + GxE

8. **Claude AI Interpretation (Week 15–16)** → `ai/claude_interpreter.py`
...
9. **GxE Analysis (Week 17–18)** → `modules/gxe_analysis.py`
...
10. **Complete ANOVA Page Integration (Week 19–20)** → `pages/04_anova.py`
...
11. **Polish + Settings (Week 21–22)** → `config/settings.py`
...
- Download Excel → verify all sheets contain correct data
